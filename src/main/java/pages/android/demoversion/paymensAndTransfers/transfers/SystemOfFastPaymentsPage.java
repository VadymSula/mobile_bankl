...
public class SystemOfFastPaymentsPage extends DemoVersionMainPage {
    ...
    public SystemOfFastPaymentsPage(AndroidDriver<MobileElement> androidDriver) {
        super(androidDriver);
    }

    @Step("Заполнить поля: ")
    public SystemOfFastPaymentsPage fillInFieldsForSBP(String transferSum, String comment) {
    ...
    public SystemOfFastPaymentsPage tapOnTransferSBPButton() {
