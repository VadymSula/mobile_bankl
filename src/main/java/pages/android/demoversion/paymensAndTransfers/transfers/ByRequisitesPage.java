...
public class ByRequisitesPage extends DemoVersionMainPage {
    ...
    public ByRequisitesPage(AndroidDriver<MobileElement> androidDriver) {
        super(androidDriver);
    }

    @Step("Заполнить поля")
    public ByRequisitesPage fillInFields(Requisites requisites, String bikSearchFieldValue) {
    ...
    public ByRequisitesPage tapOnTransferButton() {
